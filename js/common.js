...
$("#verify-btn-intro").click(function () {
    $("#otp-verify").show(0);
      $("#verify-btn-intro").hide(0);
    
});


$("#verify-btn-intro1").click(function () {
    $("#otp-verify1").show(0);
      $("#verify-btn-intro1").hide(0);
...
$('#crumbs ul li a').on('click', function() {
 
	$(this).css("background-color", '#00c0b5');
